		     ...
		     )
{
    ...
    /*
     * curr_online is set to the double amount of schedulers
     * as bootstrap. The amount is decreased in initial thread
     * function. This in order to synchronize schedulers online
     * before allow any modifications of scheduler suspend state.
     */
...
sched_thread_func(void *vesdp)
{
    ...
    schdlr_sspnd_dec_nscheds(&schdlr_sspnd.curr_online, ERTS_SCHED_NORMAL);
...
sched_dirty_cpu_thread_func(void *vesdp)
{
    ...
    schdlr_sspnd_dec_nscheds(&schdlr_sspnd.curr_online, ERTS_SCHED_DIRTY_CPU);
...
sched_dirty_io_thread_func(void *vesdp)
{
    ...
    schdlr_sspnd_dec_nscheds(&schdlr_sspnd.curr_online, ERTS_SCHED_DIRTY_IO);
