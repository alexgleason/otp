...
#define erts_smp_thr_progress_is_blocking() 0
...
ERTS_GLB_INLINE ErtsThrPrgrVal erts_thr_progess_later(void);
ERTS_GLB_INLINE ErtsThrPrgrVal erts_thr_progess_current(void);
