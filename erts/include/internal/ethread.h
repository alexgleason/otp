...
#define ETHR_OP_SPIN_LOCK		1
#define ETHR_OP_SPIN_UNLOCK		2

#define ETHR_OP_READ_LOCK		3
#define ETHR_OP_READ_UNLOCK		4
#define ETHR_OP_WRITE_LOCK		5
#define ETHR_OP_WRITE_UNLOCK		6

#define ETHR_OP_MUTEX_TRYLOCK		7
#define ETHR_OP_MUTEX_LOCK		8
#define ETHR_OP_MUTEX_UNLOCK		9

#define ETHR_OP_COND_SIGNAL		10
#define ETHR_OP_COND_BROADCAST		11
#define ETHR_OP_COND_WAIT		12

#define ETHR_OP_RWMUTEX_TRYRLOCK	13
#define ETHR_OP_RWMUTEX_RLOCK		14
#define ETHR_OP_RWMUTEX_RUNLOCK		15
#define ETHR_OP_RWMUTEX_TRYRWLOCK	16
#define ETHR_OP_RWMUTEX_RWLOCK		17
#define ETHR_OP_RWMUTEX_RWUNLOCK	18

#define ETHR_OP_MUTEX_Q_LOCK		19
#define ETHR_OP_MUTEX_Q_UNLOCK		20

#define ETHR_OP_EVENT_SET		21
#define ETHR_OP_EVENT_RESET		22
#define ETHR_OP_EVENT_WAIT		23

#define ETHR_OP_GET_TS_EVENT		24
#define ETHR_OP_LEAVE_TS_EVENT		25
...
ETHR_PROTO_NORETURN__ ethr_fatal_error__(int op, int err);
...
ETHR_INLINE_FUNC_NAME_(ethr_spin_unlock)(ethr_spinlock_t *lock)
{
    ...
    if (err)
	ethr_fatal_error__(ETHR_OP_SPIN_UNLOCK, err);
#elif defined(__WIN32__)
...
ETHR_INLINE_FUNC_NAME_(ethr_spin_lock)(ethr_spinlock_t *lock)
{
    ...
    if (err)
	ethr_fatal_error__(ETHR_OP_SPIN_LOCK, err);
#elif defined(__WIN32__)
...
#else
    return ETHR_INLINE_FUNC_NAME_(ethr_atomic_dectest)(var, val);
#endif
}
...
ETHR_INLINE_FUNC_NAME_(ethr_get_ts_event)(void)
{
	...
	if (res != 0)
	    ethr_fatal_error__(ETHR_OP_GET_TS_EVENT, res);
	ETHR_ASSERT(tsep);
    }
    return tsep;
}
...
ETHR_INLINE_FUNC_NAME_(ethr_leave_ts_event)(ethr_ts_event *tsep)
{
	...
	if (res != 0)
	    ethr_fatal_error__(ETHR_OP_LEAVE_TS_EVENT, res);
    }
}
...
ETHR_INLINE_FUNC_NAME_(ethr_rwlock_init)(ethr_rwlock_t *lock)
{
    ...
    return 0;
#else
    return ethr_rwmutex_init_sc((ethr_rwmutex *) lock, INT_MAX);
#endif
}
