...
ETHR_IMPL_NORETURN__ ethr_fatal_error__(int op, int err)
{
    char *errstr;
    char *opstr;
    switch (op) {
    case ETHR_OP_SPIN_LOCK: opstr = "ethr_spin_lock()"; break;
    case ETHR_OP_SPIN_UNLOCK: opstr = "ethr_spin_unlock()"; break;

    case ETHR_OP_READ_LOCK: opstr = "ethr_read_lock()"; break;
    case ETHR_OP_READ_UNLOCK: opstr = "ethr_read_unlock()"; break;
    case ETHR_OP_WRITE_LOCK: opstr = "ethr_write_lock()"; break;
    case ETHR_OP_WRITE_UNLOCK: opstr = "ethr_write_unlock()"; break;

    case ETHR_OP_MUTEX_TRYLOCK: opstr = "ethr_mutex_trylock()"; break;
    case ETHR_OP_MUTEX_LOCK: opstr = "ethr_mutex_lock()"; break;
    case ETHR_OP_MUTEX_UNLOCK: opstr = "ethr_mutex_unlock()"; break;

    case ETHR_OP_COND_SIGNAL: opstr = "ethr_cond_signal()"; break;
    case ETHR_OP_COND_BROADCAST: opstr = "ethr_cond_broadcast()"; break;
    case ETHR_OP_COND_WAIT: opstr = "ethr_cond_wait()"; break;

    case ETHR_OP_RWMUTEX_TRYRLOCK: opstr = "ethr_rwmutex_rlock()"; break;
    case ETHR_OP_RWMUTEX_RLOCK: opstr = "ethr_rwmutex_rlock()"; break;
    case ETHR_OP_RWMUTEX_RUNLOCK: opstr = "ethr_rwmutex_runlock()"; break;
    case ETHR_OP_RWMUTEX_TRYRWLOCK: opstr = "ethr_rwmutex_tryrwlock()"; break;
    case ETHR_OP_RWMUTEX_RWLOCK: opstr = "ethr_rwmutex_rwlock()"; break;
    case ETHR_OP_RWMUTEX_RWUNLOCK: opstr = "ethr_rwmutex_rwunlock()"; break;

    case ETHR_OP_MUTEX_Q_LOCK: opstr = "ethr_mutex_q_lock()"; break;
    case ETHR_OP_MUTEX_Q_UNLOCK: opstr = "ethr_mutex_q_unlock()"; break;

    case ETHR_OP_EVENT_SET: opstr = "ethr_event_set()"; break;
    case ETHR_OP_EVENT_RESET: opstr = "ethr_event_reset()"; break;
    case ETHR_OP_EVENT_WAIT: opstr = "ethr_event_wait()"; break;

    default: opstr = "unspecified ethread function"; break;
    }

    errstr = strerror(err);
    if (!errstr) {
	switch (err) {
	case ENOTSUP: errstr = "Not supported";
	default: errstr = "Uknown error";
	}
    }
    fprintf(stderr, "Fatal error (%d) in %s: %s\n", err, opstr, errstr);
    ethr_abort__();
}
